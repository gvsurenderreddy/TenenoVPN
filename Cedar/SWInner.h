...
// Component string
#define	SW_NAME_TEST		"test"
#define	SW_LONG_TEST			_UU("SW_LONG_TEST")
...
#define	SW_CMP_VPN_TEST				6	// TEST Component
// Exit code
...
UINT SwTestPage(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam, WIZARD *wizard, WIZARD_PAGE *wizard_page, void *param);
